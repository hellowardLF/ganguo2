...
import tv.ganguo.live.event.BroadCastEvent;
...
import tv.ganguo.live.utils.OwnNumUtils;
...
public class LoginByPhoneActivity extends BaseSiSiEditActivity {
    ...
    public void doLogin(View view) {
        ...
        if ("".equals(mobile.trim()) || !OwnNumUtils.isPhoneNumber(mobile)) {
            toast("请正确填写手机号");
            return;
        }
