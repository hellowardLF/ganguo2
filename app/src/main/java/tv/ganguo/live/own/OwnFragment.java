...
import tv.ganguo.live.own.authorize.MyAuthorizeActivity;
import tv.ganguo.live.own.family.FamilyActivity;
import tv.ganguo.live.own.fans.FansActivity;
import tv.ganguo.live.own.follow.FollowActivity;
import tv.ganguo.live.own.goexchange.GoExchangeActivity;
import tv.ganguo.live.own.level.MyLevelActivity;
import tv.ganguo.live.own.money.ChargeMoneyActivity;
import tv.ganguo.live.own.publishrecord.PublishRecordActivity;
import tv.ganguo.live.own.setting.SettingActivity;
import tv.ganguo.live.own.userinfo.ContributionActivity;
import tv.ganguo.live.own.userinfo.MyDataActivity;
...
//    TextView mTextUserSpendcoin;
    ...
    @Bind(R.id.linear_own_money_rz)
    LinearLayout mMyRz;
    @Bind(R.id.linear_own_shortvideo)
    LinearLayout shortvideo;
    @Bind(R.id.linear_own_look_list)
    ...
    @OnClick(R.id.linear_own_shortvideo)
    public void clickshortvideo(View view){
        openActivity(MyShortVideoActivity.class);
    }
    @OnClick(R.id.linear_own_look_list)
    public void clicklooklist(View view){
        openActivity(MyLookListActivity.class);
    ...
    @OnClick(R.id.linear_own_money_rz)
    public void myrz(View view) {
        if (mTextUserdataReal.getText().equals("已认证"))
            toast("已认证");
        else
            openActivity(AuthorizeActivity.class);
    }

    @OnClick(R.id.linear_own_money_myrz)
    public void rz(View view) {
       /* if (mTextUserdataReal.getText().equals("已认证"))
            toast("已认证");
        else*/
        openActivity(MyAuthorizeActivity.class);
    }
