...
public class SnapRecorderSetting extends Activity implements View.OnClickListener{
    private static final String TAG = "SnapRecorderSetting";
    String[] eff_dirs;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snap_recorder_setting);
        initView();
//        initAssetPath();
//        copyAssets();
    }
...
//                    Toast.makeText(this,"文件路径为 "+ path,Toast.LENGTH_SHORT).show();
                    ...
                    mediaPlayer.release();
                    VideoInfoActivity.start(SnapRecorderSetting.this,path,duration);
                }
...
/*    private void upFile(String path){
        ...
        params.put("video_title",);
        params.put("video_thumb",);
        params.put("video_url",);
        params.put("video_time",);
        params.put("longitude",);
        params.put("latitude",);
        Api.excuteUpload(Api.UP_SHORTVIDEO,this,);
    }*/
