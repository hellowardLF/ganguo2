...
import tv.ganguo.live.view.BubbleView;
...
//                showBigAnim("gift_anim_4", model);//汽车
            ...
            case "12":
                ...
                break;
            case "33":
                showBigAnim("gift_anim_tao_hua", model);//桃花
                break;
            case "35":
...
//    private void showGifGift(final Handler animHandler, int rid) {
//        Glide.with(LivingActivity.this).load(rid).override(300,500).
...
//                        }
//                        //发送延时消息，通知动画结束
//                        animHandler.sendEmptyMessageDelayed(10,
//                                duration);
//                        return false;
//                    }
//                }) //仅仅加载一次gif动画
...
//        mVideoTextureView.setKeepScreenOn(true);
    ...
    private String getEarn(String total_earn) {
        Log.i(TAG, "getEarn: " + total_earn);
//String total=total_earn.trim();
        if (total_earn != null && !total_earn.equals("") && !total_earn.toLowerCase().equals("null")) {
